...
const USERS: User[] = [
  ...
  },
  {
    ...
    email: "noreply@acme.example",
    display_name: "Transactional bot",
    access_subject: "access:noreply@acme.example",
    role: "sender",
    disabled_at: null,
    created_at: t(31 * DAY),
  ...
  },
  {
    ...
    email: "alerts@acme.example",
    display_name: "On-call alerts",
    access_subject: "access:alerts@acme.example",
    role: "sender",
    disabled_at: null,
    created_at: t(20 * DAY),
    updated_at: t(4 * HOUR),
  },
  {
    ...
    access_subject: "access:billing@acme.example",
    role: "sender",
    disabled_at: t(6 * DAY),
    created_at: t(45 * DAY),
    updated_at: t(6 * DAY),
...
const SENDERS: Sender[] = [
  {
    ...
    email: "noreply@mail.acme.example",
    user_id: USERS[1]!.id,
...
const SEND_EVENTS: SendEvent[] = [
  mkSend({
    ...
    ts: t(45),
    status: "accepted",
    envelope_from: "noreply@mail.acme.example",
    recipient_count: 1,
  ...
  mkSend({
    ...
    envelope_from: "billing@mail.acme.example",
    user_id: USERS[3]!.id,
    credential_id: null,
    recipient_count: 1,
...
const SENDER_SESSION: Session = {
  ...
  access: { sub: "access:alerts@acme.example", email: USERS[2]!.email },
};
